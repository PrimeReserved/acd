...
export default function HomePage() {
  ...
  return (
    <>
      ...
      {/* Stats strip — peeks at the bottom of the viewport */}
      <div
        className="w-full"
        style={{
          background:
      ...
      <section className="bg-off-white py-16 sm:py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          {/* Section header — matches reference image layout */}
          ...
          {/* Service cards grid — style from reference images */}
              ...
              {[
                {
                  value: '15+',
                  label: 'Years Active',
                  sub: 'In the energy sector',
                },
                {
                  value: '60+',
                  label: 'KM Delivered',
                  sub: 'Pipeline & flowline',
                },
                {
                  value: '20+',
                  label: 'Projects Done',
                  sub: 'For top operators',
                },
                {
                  value: '5+',
                  label: 'Major Clients',
                  sub: 'SPDC, Saipem & more',
                },
              ].map((item) => (
                <div
                  key={item.label}
