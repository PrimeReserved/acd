...
export default function ContactPage() {
  ...
  useEffect(() => {
    ...
    if (serviceId && serviceMap[serviceId]) {
      ...
      // Pulse-highlight the select for a moment
      ...
      >
        ...
        >
          ...
          <button
            ...
            className="text-white/40 hover:text-white/80 transition-colors shrink-0 p-0.5"
            aria-label="Dismiss"
          >
            <X size={15} />
          </button>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-0 rounded-3xl overflow-hidden shadow-[0_24px_80px_-12px_rgba(0,0,0,0.18)]">
            ...
            <div
              ...
              style={{
                background: 'linear-gradient(135deg, #0f3460 0%, #8b1515 100%)',
              }}
            >
              {/* Subtle texture */}
              <div
              ...
              <div className="relative z-10">
                <div className="mb-8 sm:mb-10">
                  <span className="text-orange font-bold text-[10px] tracking-[0.22em] uppercase block mb-3">
                    Get In Touch
                  </span>
                ...
                <div className="space-y-6">
                  ...
                  <div className="flex gap-4">
                    ...
                    <div>
                      <div className="text-white/50 text-[10px] font-bold tracking-[0.15em] uppercase mb-1.5">
                        Office Address
                      </div>
                      ...
                      <div className="space-y-1.5">
                        {phones.map((n) => (
                          <a
                            ...
                            className="block text-white/85 hover:text-orange text-sm transition-colors duration-200"
                          >
                            {n}
                          </a>
                        ))}
                  ...
                  <div className="flex gap-4">
                    ...
                    <div>
                      ...
                      <a
                        ...
                        className="text-white/85 hover:text-orange text-sm transition-colors duration-200"
                      >
              ...
              >
                ...
                <div>
                  <div className="text-orange font-heading font-bold text-sm">
                    24 / 7 Emergency Response
                  </div>
                  <div className="text-white/60 text-xs mt-0.5">
                    For urgent on-site operational issues — call any time.
                  </div>
                </div>
              </div>
            </div>
            ...
            <div ref={formRef} className="lg:col-span-3 bg-white p-8 sm:p-10 lg:p-12">
              {status !== 'success' && (
                <div className="mb-7">
                  <h3 className="font-heading font-black text-2xl text-navy mb-1.5">
                    Send Us a Message
                  </h3>
                  <p className="text-steel/65 text-sm">
              ...
              {status === 'success' ? (
                <div className="flex flex-col items-center justify-center py-16 text-center gap-4">
                  ...
                  <button
                    ...
                    className="mt-2 text-xs font-bold text-orange hover:underline"
                  >
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                    ...
                    {selectedService && selectedService !== 'General Enquiry' && (
                      <div className="flex items-center gap-1.5 mt-2">
                        ...
                        <span className="text-[11px] text-orange font-semibold">
                          Service pre-selected — fill in your details and submit below
                        </span>
                      </div>
                    )}
                  </div>
                  ...
                  <div>
                    ...
                    <textarea
                      rows={5}
                      placeholder="Describe your project, scope, location, timeline, and any other relevant details..."
                      value={message}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-5">
            {[
              {
                label: "Head Office",
                value: "No. 1 Exozia Close, Airport Road, Port Harcourt",
              },
              {
                label: "State",
                value: "Rivers State, Federal Republic of Nigeria",
              },
              {
                label: "Operating Regions",
                value: "Niger Delta · Imo State · Ondo State · Nationwide",
              },
            ].map((item) => (
              <div
                key={item.label}
              ...
              >
                <div className="text-navy font-heading font-bold text-xs tracking-widest uppercase mb-2">
                  {item.label}
                </div>
